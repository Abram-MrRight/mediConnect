    ...
    <div class="bg-white p-8 rounded-lg shadow-md" id="dashboard-container">
        ...
        <div class="mt-10">
            ...
            <div class="flex space-x-6">
                <a href="{{ route('doctors.appointments') }}" class="bg-blue-600 hover:bg-blue-700 text-white py-3 px-6 rounded-2xl shadow-md hover:shadow-lg transition duration-300 flex items-center">
