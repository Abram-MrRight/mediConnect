  ...
  <div class="grid lg:grid-cols-2 gap-6">
    ...
    <a class="group sm:flex rounded-xl" href="#">
      <div class="flex-shrink-0 relative rounded-xl overflow-hidden h-[200px] sm:w-[250px] sm:h-[350px] w-full">
        <img class="size-full absolute top-0 start-0 object-cover" src="{{asset('doc.jpg')}}" alt="Image Description">
      </div>
          ...
          <div class="mt-5 sm:mt-auto">
            ...
            <div class="flex items-center">
              <div class="flex-shrink-0">
                <img class="size-[46px] rounded-full" src="{{asset('doc.jpg')}}" alt="Image Description">
              </div>
